...
diferencia_con_min = 100 - lopez_curso / otros_cursos_min * 100
diferencia_con_max = 100 - lopez_curso * 1000 // otros_cursos_max / 10
diferencia_con_promedio = 100 - lopez_curso / otros_cursos_promedio * 100

#Calculando el porcentaje de tiempo vacìo removido
tiempo_vacio_promedio =  100 - otros_cursos_promedio * 1000 // crudo_promedio / 10
tiempo_vacio_dalto =  100 - lopez_curso * 1000 // crudo_lopez / 10


#Mostrando las diferencias de duraciòn (ejercicio A)

print("----------------")
print("El curso de lopez dura:")
...
print(f'Ver 10 horas de este curso equivale a ver {otros_cursos_promedio * 100 // lopez_curso / 10} horas de otros cursos')
print(f'Ver 10 horas de otros cursos equivale a ver {lopez_curso * 100 // otros_cursos_promedio / 10} horas de este curso')
print("----------------")